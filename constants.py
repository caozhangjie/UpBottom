...
try:
    from credentials import FEISHU_WEBHOOK_WATERLINE_SELL as CREDENTIALS_FEISHU_WEBHOOK_WATERLINE_SELL
except ImportError:
    CREDENTIALS_FEISHU_WEBHOOK_WATERLINE_SELL = ""
...
FEISHU_WEBHOOKS = {
    ...
    "waterline_sell": os.environ.get("FEISHU_WEBHOOK_WATERLINE_SELL", "") or CREDENTIALS_FEISHU_WEBHOOK_WATERLINE_SELL,
